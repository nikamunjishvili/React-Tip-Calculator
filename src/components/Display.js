    ...
    <div className="display">
        ...
        <div className="display-row">
            <div className="display-label">
                ...
                returnCurrencyAmt(`${calculatedTip ? calculatedTip/people: "0"}`)}</p>
            </div>
            <div className="display-row">
            <div className="display-label">
                <p className="header">Tip Amount</p>
            ...
            <p className="display-amt">{
            returnCurrencyAmt(`${total ? total/people : "0"}`)}</p>
        </div>
        </div>
         {
            total ? (<button className="btn" 
            onClick={handleResetBtn}>Reset</button>)
